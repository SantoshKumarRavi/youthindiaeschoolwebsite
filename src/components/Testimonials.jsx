...
const defaultTestimonials = [
  {
    ...
    quote:
    "The school management software has made it so much easier for me to see how our school is doing as a whole",
    customerName: "Aadinath",
    customerTitle: "Teacher,TOWN NODAL High School",
  },
    {
      imageSrc:
      ...
      quote:
        "I love using the school management software! It makes it so easy to check my attendance and grades, and I always know where I stand.",
      customerName: "Sambit",
      customerTitle: "Student,BISRA High School",
    },
    {
      imageSrc:
        "https://images.unsplash.com/photo-1523952578875-e6bb18b26645?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1024&q=80",
      profileImageSrc:
        "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=512&h=512&q=80",
      quote:"I used to spend hours each week taking attendance and grading assignments, but now it's all automated.",
      customerName: "Loknath",
      customerTitle: "Teacher,BISRA High School.",
    },
    {
        imageSrc:
          "https://images.unsplash.com/photo-1512100356356-de1b84283e18?ixlib=rb-1.2.1&auto=format&fit=crop&w=1024&q=80",
        profileImageSrc:
          "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.25&w=512&h=512&q=80",
        quote:
          "We used to spend hours each week inputting data and cross checking it again to verify, but now it's all automated",
        customerName: "Jaychand",
        customerTitle: "Admin,TOWN NODAL High School",
      }
  ];
  return (
    <Container>
          ...
          <TestimonialText key={index}>
            ...
            <CustomerInfo>
              <CustomerProfilePicture
                src={"/assests/profile-circle.png"}
